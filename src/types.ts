...
export interface PlanDependency {
  from: string; // ID of the dependent item
  to: string; // ID of the item being depended on
...
export interface Skill {
  ...
  protocol?: string;
  content: string;
  dependencies?: string[]; // Skills this skill depends on
  calls?: string[]; // Other skills this skill calls
}
...
export interface SkillExecutionContext {
  ...
  compositionEngine?: any; // Use 'any' temporarily to resolve the circular reference
  currentSkill?: Skill;
  allSkills?: Skill[];
