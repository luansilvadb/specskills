...
export class PlanModeManager {
  private static session: PlanModeSession | null = null;
   ...
   */
  static validatePermission(operation: string, _details?: any): { allowed: boolean; reason?: string } {
    if (!this.session) {
 ...
 */
export async function withPlanModeProtection(
  commandName: string,
