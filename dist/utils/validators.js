...
exports.PlanValidator = exports.SpecValidator = void 0;
class SpecValidator {
    /**
     ...
     */
    static validateAcceptanceCriterion(criterion) {
        const errors = [];
        const warnings = [];
...
class PlanValidator {
     ...
     */
    static validatePlanDependency(dependency) {
        const errors = [];
        const warnings = [];
     ...
     */
    static validateMilestone(milestone) {
        const errors = [];
        const warnings = [];
